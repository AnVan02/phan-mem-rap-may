...
<main class="main-content-order-status">
   ...
   <div class="filter-controls">
      <div class="status-tabs">
         ...
         <div class="tab" data-filter="pending">Chờ nhập Serial <span class="tab-count" id="count-pending">0</span></div>
         <div class="tab" data-filter="completed">Đang lắp ráp <span class="tab-count" id="count-completed">0</span></div>
         <div class="tab" data-filter="checking">Chờ đối chiếu <span class="tab-count" id="count-checking">0</span></div>
         <div class="tab" data-filter="processing">Hoàn thành <span class="tab-count" id="count-processing">0</span></div>
      </div>
   ...
   document.addEventListener('DOMContentLoaded', function() {
      ...
      searchInput.addEventListener('input', () => {
        ...
        function updateTabCounts() {
         const counts = { all: 0, pending: 0, completed: 0, checking: 0, processing: 0 };
         rows.forEach(row => {
